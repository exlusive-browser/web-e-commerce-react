...
export function Footer() {
  return (
    <footer className="block w-full  bg-[#1c2833]  text-white  p-6 ">
      ...
      <div className="flex justify-between items-center px-8 mb-6 gap-8">
        <div className="m-0 text-[20px] font-sans font-bold">
          <h3>Up Ecommerce</h3>
          <p className="my-1.5 text-[14px]">NIT: 123456789</p>
        </div>
      ...
      <div className="flex justify-center items-center  p-2.5 px-5">
        <ul className="flex list-none p-0 m-0 text-center space-x-6">
          <li>
            <a href="">Home</a>
          </li>
          <li>

...
import product1Image from "@/assets/images/product1.png";import product10Image from "@/assets/images/product10.png";import product11Image from "@/assets/images/product11.png";import product7Image from "@/assets/images/product7.png"; import product5Image from "@/assets/images/product5.png"; import product3Image from "@/assets/images/product3.png"; import product4Image from "@/assets/images/product4.png"; import product2Image from "@/assets/images/product2.png"; import product6Image from "@/assets/images/product6.png"; import product8Image from "@/assets/images/product8.png"; import product9Image from "@/assets/images/product9.png"; import product12Image from "@/assets/images/product12.png";
import product1HoverImage from "@/assets/images/product1-hover.png";import product10HoverImage from "@/assets/images/product10-hover.png";import product11HoverImage from "@/assets/images/product11-hover.png"; import product7HoverImage from "@/assets/images/product7-hover.png"; import product5HoverImage from "@/assets/images/product5-hover.png"; import product3HoverImage from "@/assets/images/product3-hover.png"; import product4HoverImage from "@/assets/images/product4-hover.png"; import product2HoverImage from "@/assets/images/product2-hover.png"; import product6HoverImage from "@/assets/images/product6-hover.png"; import product8HoverImage from "@/assets/images/product8-hover.png"; import product9HoverImage from "@/assets/images/product9-hover.png"; import product12HoverImage from "@/assets/images/product12-hover.png";
      ...
      <div className="container mx-auto p-5">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
          {products.map((product) => (
            <div className="bg-white border border-gray-300 rounded-lg shadow-md p-4 flex flex-col justify-between transition-transform transform hover:scale-105" key={product.id}>
              <Link to={`/product/${product.id}`} className="flex-1">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-gray-500 text-[12px] font-sans">{product.brand}</p>
                  ...
                  <p className="text-gray-500 text-[12px] font-sans">{product.rating}</p>
                </div>
              </Link>
              <button 
                onClick={(e) => {
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-4 h-4 mr-2 md:w-5 md:h-5">
        ...
        <div className="flex justify-center mt-5">
          <button className="bg-blue-500 text-white px-4 py-2 rounded mr-2 font-sans">1</button>
          <button className="bg-gray-300 text-gray-700 px-4 py-2 rounded mr-2 font-sans">2</button>
          <button className="bg-gray-300 text-gray-700 px-4 py-2 rounded font-sans">3</button>
        </div>
      </div>
    </MainLayout>
  );
